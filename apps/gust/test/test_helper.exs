...
Mox.defmock(Gust.DAGSchedulerMock, for: Gust.DAG.Scheduler)
...
Mox.defmock(Gust.DAGRunRestarterMock, for: Gust.DAG.RunRestarter)
...
Application.put_env(:gust, :dag_scheduler, Gust.DAGSchedulerMock)
...
Application.put_env(:gust, :dag_run_restarter, Gust.DAGRunRestarterMock)
